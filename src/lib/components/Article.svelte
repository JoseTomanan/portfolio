...
<article class="
  ...
  hover:bg-lucy-surface-alt hover:border-lucy-border-alt hover:shadow-lucy-border-alt hover:shadow-sm
...
">
  ...
  <div class="basis-5/6 md:basis-3/4 flex flex-col gap-0.5">
    <div class="grid">
      ...
      <h5 class="text-lucy-fg/90 mt-0">{subtitle}</h5>
    </div>

    <p class="text-sm grow tracking-tight">
      {other}
    </p>
